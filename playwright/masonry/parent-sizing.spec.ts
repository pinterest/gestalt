...
test.describe('Masonry: Parent Sizing', () => {
  test('starts the grid from the left bounding box of the parent', async ({ page }) => {
    await page.goto(getServerURL({ virtualize: true, finiteLength: true, constrained: true }));
