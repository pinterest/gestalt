...
import DateRange, { type LocaleData } from './DateRange.js';
...
|}) {
  ...
  const [endDate, setEndtDate] = useState<Date | null>(initialEndDate ?? null);
  ...
  return (
    <DateRange
      ...
      localeData={localeData}
      onCancel={() => {}}
      onEndDateChange={({ value }) => setEndtDate(value)}
      onEndDateError={() => {}}
