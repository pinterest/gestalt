...
import "react";
declare type NodeOrRenderProp = Node | ((arg0: {
    onDismissStart: () => void;
}) => Node);
declare type Props = {
    /**
 ...
 */
declare function OverlayPanel({ accessibilityDismissButtonLabel, accessibilityLabel, children, closeOnOutsideClick, footer, heading, onAnimationEnd, dismissConfirmation, onDismiss, size, subHeading, }: Props): Node;
