 ...
 *
 */
export default function Popover({ accessibilityLabel, accessibilityDismissButtonLabel, anchor, children, showDismissButton, onKeyDown, id, idealDirection, onDismiss, positionRelativeToAnchor, color, role, shouldFocus, showCaret, size, __dangerouslySetMaxHeight, }: Props): null | Node;
export {};
