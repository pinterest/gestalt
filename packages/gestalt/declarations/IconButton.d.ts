...
declare type IconButtonType = BaseIconButton & {
...
declare type LinkIconButtonType = BaseIconButton & {
  href: string;
  rel?: 'none' | 'nofollow';
  role: 'link';
  target?: null | 'self' | 'blank';
};
declare type unionProps = IconButtonType | LinkIconButtonType;
