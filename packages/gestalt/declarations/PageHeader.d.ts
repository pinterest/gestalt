...
import "./boxTypes";
export declare type ActionType = Element<typeof Button | typeof IconButton | typeof Link | typeof Text | typeof Tooltip>;
declare type Props = {
    /**
 ...
 *
 */
export default function PageHeader({ badge, dropdownAccessibilityLabel, helperIconButton, helperLink, items, maxWidth, primaryAction, secondaryAction, subtext, title, thumbnail, borderStyle, }: Props): Node;
export {};
