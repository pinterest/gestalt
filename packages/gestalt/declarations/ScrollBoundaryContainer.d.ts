...
import "react";
declare type ScrollBoundaryContainerOverflow = "scroll" | "scrollX" | "scrollY" | "auto" | "visible";
declare type Props = {
    children: Node;
    /**
 ...
 */
declare function ScrollBoundaryContainerWithProvider({ children, height, overflow, }: Props): Node;
