...
declare type Props = {
   ...
   */
  onBlur?: (arg0: { event: React.FocusEvent<HTMLInputElement>; value: number | void }) => void;
  /**
   * Callback triggered when the value of the input changes, whether by keyboard entry or the input's arrows.
   */
  onChange: (arg0: { event: React.SyntheticEvent<HTMLInputElement>; value: number | void }) => void;
  /**
   * Callback triggered when the user focuses the input.
   */
  onFocus?: (arg0: { event: React.FocusEvent<HTMLInputElement>; value: number | void }) => void;
  /**
