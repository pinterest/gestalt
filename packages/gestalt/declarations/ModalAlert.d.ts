 ...
 *
 */
export default function ModalAlert({ accessibilityDismissButtonLabel, accessibilityModalLabel, type, children, onDismiss, heading, primaryAction, secondaryAction, }: Props): Node;
export {};
