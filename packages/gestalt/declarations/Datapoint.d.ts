...
import "./zIndex";
declare type TrendObject = {
    accessibilityLabel: string;
    value: number;
};
declare type BadgeObject = {
    text: string;
 ...
 *
 */
export default function Datapoint({ badge, size, title, tooltipText, tooltipZIndex, trend, trendSentiment, value, }: Props): Node;
export {};
