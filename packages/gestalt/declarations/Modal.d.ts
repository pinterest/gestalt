 ...
 *
 */
export default function Modal({ _dangerouslyDisableScrollBoundaryContainer, accessibilityModalLabel, align, children, closeOnOutsideClick, onDismiss, footer, padding, heading, role, size, subHeading, }: Props): Node;
export {};
