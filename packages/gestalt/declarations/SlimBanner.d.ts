...
declare type DismissButtonType = {
    accessibilityLabel: string;
    onDismiss: () => void;
};
declare type HelperLinkType = {
    accessibilityLabel: string;
    href: string;
    onClick?: (arg0: {
 ...
 *
 */
export default function SlimBanner({ dismissButton, helperLink, iconAccessibilityLabel, message, primaryAction, type, }: Props): Node;
export {};
