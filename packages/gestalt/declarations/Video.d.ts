...
declare type Source = string | ReadonlyArray<{
...
export default class Video extends PureComponent<Props, State> {
    ...
    handleControlsPlay: (event: React.SyntheticEvent<HTMLDivElement> | React.SyntheticEvent<HTMLAnchorElement>) => void;
    handleControlsPause: (event: React.SyntheticEvent<HTMLDivElement> | React.SyntheticEvent<HTMLAnchorElement>) => void;
