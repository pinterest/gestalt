...
const disallowedProps = [
  "onClick",
  "className",
  "style", // We're currently also explicitly disallowing the deprecated marginLeft/Right
 ...
 */
const BoxWithForwardRef: AbstractComponent<Props, HTMLElement> = forwardRef<
  Props,
  HTMLElement
