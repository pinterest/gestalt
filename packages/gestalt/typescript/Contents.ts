...
class Contents extends Component<Props, State> {
  ...
  render(): Node {
    ...
    return (
      <div
        className={styles.container} // popoverOffset positions the Popover component
        style={{
          stroke,
          visibility,
          ...popoverOffset,
      ...
      >
        ...
        >
          {caret && popoverDir && (
            <div
              className={classnames(colors[bgColorElevated], styles.caret)} // caretOffset positions the Caret on the Popover
              style={{ ...caretOffset }}
            >
              <Caret
