...
export const TabWithForwardRef: AbstractComponent<
  TabProps,
  HTMLElement
> = forwardRef<TabProps, HTMLElement>(function Tab(
    ...
    <Box id={id} paddingY={3} ref={ref}>
      ...
      >
        <Flex alignItems="center" direction="column">
          <Box // $FlowExpectedError[incompatible-type] Flow doesn't understand the non-RGBA colors are valid for Box
          ...
          >
            ...
            {isActive && (
              <Box
                ...
                position="absolute" // 4px/boint, padding on left and right
