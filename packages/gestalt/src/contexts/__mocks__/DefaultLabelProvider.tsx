...
const MockContext: Context<DefaultLabelContextType | null | undefined> =
  createContext<DefaultLabelContextType | null | undefined>(fallbackLabels);
...
export default function DefaultLabelProvider(
  {
    children,
    labels,
  }: Props,
...
export function useDefaultLabelContext<C extends ValidComponent>(componentName: C): DefaultLabelContextType[C] {
