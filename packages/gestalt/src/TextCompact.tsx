...
/**
 * [TextCompact](https://gestalt.pinterest.systems/web/textcompact) component for metadata, annotations, and other instances where text should be small and dense. Its line height is tighter than the Text component.
 *
