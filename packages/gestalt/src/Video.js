...
type Props = {|
  ...
  onEnded?: ({ event: SyntheticEvent<HTMLVideoElement> }) => mixed,
  onFullscreenChange?: ({ event: Event, fullscreen: boolean }) => mixed,
  onLoadedChange?: ({
    event: SyntheticEvent<HTMLVideoElement>,
    loaded: number,
  }) => mixed,
  onPlay?: ({ event: SyntheticEvent<HTMLDivElement> }) => mixed,
  onPause?: ({ event: SyntheticEvent<HTMLDivElement> }) => mixed,
  onReady?: ({ event: SyntheticEvent<HTMLVideoElement> }) => mixed,
  onSeek?: ({ event: SyntheticEvent<HTMLVideoElement> }) => mixed,
  onTimeChange?: ({
    event: SyntheticEvent<HTMLVideoElement>,
    time: number,
  }) => mixed,
