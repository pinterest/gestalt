 ...
 *
 */
export default class Masonry<T extends {
  ...
  setGridWrapperRef: (ref?: HTMLElement | null | undefined) => void = (ref?: HTMLElement | null) => {
    this.gridWrapper = ref;
  };

  setScrollContainerRef: (ref?: ScrollContainer | null | undefined) => void = (ref?: ScrollContainer | null) => {
