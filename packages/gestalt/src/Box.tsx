...
type Props = {
 ...
 /**
    ...
    * Default: 'div'
    */
 as?: "article" | "aside" | "caption" | "details" | "div" | "figcaption" | "figure" | "footer" | "header" | "main" | "nav" | "p" | "section" | "summary",
 /**
...
const BoxWithForwardRef = forwardRef<HTMLElement, Props>(function Box(
 ...
 ref,
  ...
  const { passthroughProps, propsStyles } = buildStyles<Flow.Diff<Props, {
   as?: As
  }>>({
