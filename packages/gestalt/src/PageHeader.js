...
type Props = {|
  ...
  /**
   * Specify a bottom border style for PageHeader: "sm" is 1px. See the [Border variant](https://gestalt.pinterest.systems/pageheader#Border) to learn more.
   */
  borderStyle?: 'sm' | 'none',
  /**
   * Label used for screen readers to provide information about the [IconButton](https://gestalt.pinterest.systems/iconbutton) replacing actions the [sm breakpoint](https://gestalt.pinterest.systems/screen_sizes#Web-(px)).
   */
  dropdownAccessibilityLabel?: string,
  /**
   * Helper [IconButton](https://gestalt.pinterest.systems/iconbutton) to be placed after the title for a supplemental Call To Action (CTA). See the [Title variant](https://gestalt.pinterest.systems/pageheader#Title) to learn more. See the [Primary action variant](https://gestalt.pinterest.systems/pageheader#Primary-action) or [Secondary action variant](https://gestalt.pinterest.systems/pageheader#Secondary-action) to learn more.
   */
  helperIconButton?: {|
  ...
  /**
   * Use numbers for pixels: \`maxWidth={100}\` and strings for percentages: \`maxWidth="100%"\`. See the [Max width variant](https://gestalt.pinterest.systems/pageheader#Max-width) variant for more info.
   */
                ...
                <Flex gap={2}>
                  ...
                  <Flex direction="column" gap={1}>
                    <Flex alignItems="center">
                      <PageHeaderTitle hasThumbnail={!!thumbnail} title={title} />
