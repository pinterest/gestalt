...
>(function ComboBox(props: Props, ref): Node {
  ...
  // ==== TAGS: Force disable state in Tags if [deprecated]Typeahead is disabled as well ====
  ...
  // ==== KEYBOARD NAVIGATION LOGIC: Keyboard navigation is handled by [deprecated]Typeahead while onClick selection is handled in ComboBoxOption ====
