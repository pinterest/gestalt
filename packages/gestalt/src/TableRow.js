// @flow strict
import type { Node as $IMPORTED_TYPE$_Node } from "react";import { type Node, Children, cloneElement, useEffect, useRef, useState } from 'react';
...
export default function TableRow({ children }: Props): Node {
  ...
  const renderCellWithIndex = (child: $IMPORTED_TYPE$_Node, index: number) => {
