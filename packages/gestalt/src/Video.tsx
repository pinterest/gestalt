...
export default class Video extends PureComponent<Props, State> {
  ...
  handlePlayheadDown: (event: React.MouseEvent<HTMLDivElement> | React.TouchEvent<HTMLDivElement>) => void = (event) => {
  ...
  handlePlayheadUp: (event: React.MouseEvent<HTMLDivElement> | React.TouchEvent<HTMLDivElement>) => void = (event) => {
