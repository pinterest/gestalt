...
type Props = {
   ...
   */
  onControlsPlay?: (arg1: { event: React.SyntheticEvent<HTMLDivElement> }) => void;
  /**
   * Callback triggered when playback is paused via the video control interface.
   */
  onControlsPause?: (arg1: { event: React.SyntheticEvent<HTMLDivElement> }) => void;
  /**
   ...
   */
  onEnded?: (arg1: { event: React.SyntheticEvent<HTMLVideoElement> }) => void;
  /**
   ...
   */
  onError?: (arg1: { event: React.SyntheticEvent<HTMLVideoElement> }) => void;
  /**
   ...
   */
  onPause?: (arg1: { event: React.SyntheticEvent<HTMLVideoElement> }) => void;
  /**
   ...
   */
  onPlay: (arg1: { event: React.SyntheticEvent<HTMLVideoElement> }) => void;
  /**
   ...
   */
  onPlayError: (arg1: { error: Error }) => void;
  /**
   ...
   */
  onFullscreenChange?: (arg1: { event: Event; fullscreen: boolean }) => void;
  /**
   ...
   */
  onLoadStart?: (arg1: { event: React.SyntheticEvent<HTMLVideoElement> }) => void;
  /**
   ...
   */
  onPlaying?: (arg1: { event: React.SyntheticEvent<HTMLVideoElement> }) => void;
  /**
   ...
   */
  onReady?: (arg1: { event: React.SyntheticEvent<HTMLVideoElement> }) => void;
  /**
   ...
   */
  onSeek?: (arg1: { event: React.SyntheticEvent<HTMLVideoElement> }) => void;
  /**
   ...
   */
  onSeeking?: (arg1: { event: React.SyntheticEvent<HTMLVideoElement> }) => void;
  /**
   ...
   */
  onStalled?: (arg1: { event: React.SyntheticEvent<HTMLVideoElement> }) => void;
  /**
   ...
   */
  onTimeChange?: (arg1: { event: React.SyntheticEvent<HTMLVideoElement>; time: number }) => void;
  /**
   ...
   */
  onVolumeChange?: (arg1: { event: React.SyntheticEvent<HTMLDivElement>; volume: number }) => void;
  /**
   ...
   */
  onWaiting?: (arg1: { event: React.SyntheticEvent<HTMLVideoElement> }) => void;
  /**
...
export default class Video extends PureComponent<Props, State> {
  ...
  static displayName: string | null | undefined = 'Video';
  ...
  handleCanPlay: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
  ...
  handleControlsPlay: (event: React.SyntheticEvent<HTMLDivElement>) => void = (event) => {
  ...
  handleControlsPause: (event: React.SyntheticEvent<HTMLDivElement>) => void = (event) => {
  ...
  handleDurationChange: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
  ...
  handleEnded: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
  ...
  handleError: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
  ...
  handleLoadStart: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
  ...
  handlePause: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
  ...
  handlePlay: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
  ...
  // Sent when playback of the media is ready to start after having been paused.
  handlePlaying: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
  ...
  handleProgress: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
  ...
  handleSeek: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
  ...
  handleSeeking: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
  ...
  handleStalled: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
  ...
  handleTimeUpdate: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
  ...
  handleVolumeChange: (event: React.SyntheticEvent<HTMLDivElement>) => void = (event) => {
  ...
  handleWaiting: (event: React.SyntheticEvent<HTMLVideoElement>) => void = (event) => {
