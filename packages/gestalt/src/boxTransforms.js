...
export const propToFn = {
  xs: (value: ?ResponsiveProps): Style => {
    if (!value) {
      return identity();
    }
    return mapClassName(c => styles[c])(
      prefix('xs')(
        concat([
          value.column ? columnRange(value.column) : identity(),
          typeof value.display !== 'undefined'
            ? displayFunctor(value.display)
            : identity(),
        ])
      )
    );
  },
  sm: (value: ?ResponsiveProps): Style => {
    if (!value) {
      return identity();
    }
    return mapClassName(c => styles[c])(
  ...
  md: (value: ?ResponsiveProps): Style => {
    if (!value) {
      return identity();
    }
    return mapClassName(c => styles[c])(
  ...
  lg: (value: ?ResponsiveProps): Style => {
    if (!value) {
      return identity();
    }
    return mapClassName(c => styles[c])(
