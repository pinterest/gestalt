...
export type As = "article" | "aside" | "caption" | "details" | "div" | "figcaption" | "figure" | "footer" | "header" | "main" | "nav" | "p" | "section" | "summary";
export type Bottom = boolean;
export type BorderStyle = "sm" | "lg" | "shadow" | "raisedTopShadow" | "raisedBottomShadow" | "none";
export type Color = "darkGray" | "darkWash" | "gray" | "lightGray" | "lightWash" | "red" | "transparent" | "transparentDarkGray" | "white";
