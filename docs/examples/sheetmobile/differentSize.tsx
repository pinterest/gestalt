...
export default function Example() {
  ...
  const [showComponentData, setShowComponentData] = useState<string | null | undefined>(null);
  const [showNextData, setShowNextData] = useState<string | null | undefined>(null);
