...
const labels = {
  ...
  InfoButton: {
    accessibilityDefaultTooltipMessage: myI18nTranslator('Click to learn more'),
    accessibilityDefaultLinkLabel: myI18nTranslator('Learn more'),
    accessibilityIcon: myI18nTranslator('Question mark icon'),
  },
};
