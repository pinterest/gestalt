...
import removeGoogleAnalyticsCookies from '../utils/removeGoogleAnalyticsCookies';
    ...
    return (
      <Html dir={dir} lang="en">
        <Head>
          ...
          {/* Clears any Google Analytics cookies left in the browser from before GA was removed */}
          <script
            // eslint-disable-next-line react/no-danger
            dangerouslySetInnerHTML={{ __html: removeGoogleAnalyticsCookies }}
          />
