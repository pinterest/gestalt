...
export default function MessagingPrinciples(): Node {
  return (
    <Page title="Messaging principles">
      <PageHeader name="Messaging principles" type="guidelines" description={`Messaging patterns detail how we communicate errors, warnings, successes, recommendations and general information on system status. Messages can be either generated immediately after a user performs an action, or can be generated by the system automatically in order to help someone understand and navigate a product.
        ...
        >
          ...
          <Flex.Item flex="grow" flexBasis="0%" minWidth={275} maxWidth="45%">
            <PrincipleItem
              ...
              text={
                <Text>
                  Messages should be brief and should not distract a user or get in the way of completing a task. They shouldn’t appear too often in the experience.
                </Text>
              }
            />
          </Flex.Item>
          <Flex.Item flex="grow" flexBasis="0%" minWidth={275} maxWidth="45%">
            <PrincipleItem
              ...
              text={
                <Text>
                  The information or alerts provided should be relevant to the surface a user currently is working on, and be placed near the sections they relate to.
                </Text>
              }
            />
          </Flex.Item>
