    ...
    <Page title="Messaging priority and placement">
      ...
      <MainSection name="Prominence and placement" description="Prominence of a message is determined by its severity. The amount of time it remains on screen is also determined by severity." >
        <MainSection.Subsection title="Overlays">
          ...
          <Box>
          <Flex alignItems='center'><Box padding={4} width="50%"><Flex gap={1} alignItems='center'><Status type='ok' /> <Text weight='bold'>When to use</Text></Flex></Box><Box padding={4} width="50%"><Text weight='bold'>Example wireframe</Text></Box></Flex>
            <Box color='successWeak'>
              <Flex direction='column'>
                <Box color='successBase' height={4} width="100%" />
                <Flex alignItems='center'><Box padding={4} width="50%"><Text>To confirm that someone wants to peform a destructive/irreversible action</Text></Box><Box padding={4} width="50%"><DeleteBoard /></Box></Flex>
                <Divider />
                <Flex alignItems='center'><Box padding={4} width="50%"><Text>When an issue is so severe that it’s hard to continue with a good experience</Text></Box><Box padding={4} width="50%"><WebsiteBlocked /></Box></Flex>
                <Divider />
                <Flex alignItems='center'><Box padding={4} width="50%"><Text>To warn a person of something that can have serious consequences before they continue</Text></Box><Box padding={4} width="50%"><SiteSpam /></Box></Flex>
                <Divider />
                <Flex alignItems='center'><Box padding={4} width="50%"><Text>As an interstitial that leads to a much better experience we think a person shouldn’t miss</Text></Box><Box padding={4} width="50%"><ExperienceTrends /></Box></Flex>
              </Flex>
            </Box>
          </Box>

          <Box>
            <Flex alignItems='center'><Box padding={4} width="50%"><Flex gap={1} alignItems='center'><Status type='problem' /> <Text weight='bold'>When not to use</Text></Flex></Box><Box padding={4} width="50%"><Text weight='bold'>Example wireframe</Text></Box></Flex>
            <Box color='errorWeak'>
              <Flex direction='column'>
                <Box color='errorBase' height={4} width="100%" />
                <Flex alignItems='center'><Box padding={4} width="50%"><Text>To acknowledge completion of a task that doesn’t require follow up, like pinning to a board. Use <Link href='/web/toast' underlined inline>Toast</Link> instead.</Text></Box><Box padding={4} width="50%"><PinSaved /></Box></Flex>
                <Divider />
                <Flex alignItems='center'><Box padding={4} width="50%"><Text>To provide general information and recommendations. Use <Link href='/web/callout' underlined inline>Callout</Link> instead.</Text></Box><Box padding={4} width="50%"><NewRecommendations /></Box></Flex>
                <Divider />
                <Flex alignItems='center'><Box padding={4} width="50%"><Text>To show an error or warning that applies to a section of a page, or that doesn’t severely limit the user experience.</Text></Box><Box padding={4} width="50%"><CampaignIssue /></Box></Flex>
              </Flex>
            </Box>
          </Box>
        </MainSection.Subsection>
