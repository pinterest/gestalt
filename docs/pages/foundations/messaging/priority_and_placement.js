    ...
    <Page title="Messaging priority and placement">
            ...
            <Table accessibilityLabel='Table of messaging priorities and types'>
              ...
              <Table.Body>
                <Table.Row>
                  ...
                  <Table.Cell><Flex gap={2}><Icon accessibilityLabel='error' icon="workflow-status-problem" color='error' /><Text>Error</Text></Flex></Table.Cell>
                </Table.Row>
                <Table.Row>
                  <Table.Cell><Text>High</Text></Table.Cell>
                  <Table.Cell><Flex gap={2}><Icon accessibilityLabel='warning' icon="workflow-status-warning" color='warning' /><Text>Warning</Text></Flex></Table.Cell>
                </Table.Row>
                <Table.Row>
                  <Table.Cell><Text>Medium</Text></Table.Cell>
                  <Table.Cell><Flex gap={2}><Icon accessibilityLabel='success' icon="workflow-status-ok" color='success' /><Text>Success</Text></Flex></Table.Cell>
                </Table.Row>
                <Table.Row>
                  <Table.Cell><Text>Low</Text></Table.Cell>
                  <Table.Cell><Flex gap={2}><Icon accessibilityLabel='recommendation' icon="sparkle" color='recommendation' /><Text>Recommendations</Text></Flex></Table.Cell>
                </Table.Row>
                <Table.Row>
                  <Table.Cell><Text>Lowest</Text></Table.Cell>
                  <Table.Cell><Flex gap={2}><Icon accessibilityLabel='info' icon="info-circle" color='info' /><Text>Info</Text></Flex></Table.Cell>
                </Table.Row>
              </Table.Body>
            </Table>
          </Box>
      ...
      <MainSection name="Prominence and placement" description="Prominence of a message is determined by its severity. The amount of time it remains on screen is also determined by severity." >
            ...
            <Box color='successWeak'>
              <Flex direction='column'>
                ...
                <Box display='flex' alignItems='center'direction='column' lgDirection='row'>
                  <Box padding={4} width="50%">
                    <Text>To confirm that someone wants to peform a destructive/irreversible action</Text>
                    </Box>
                  <Box padding={4} width="50%">
                    <DeleteBoard />
                  </Box>
                ...
                <Box display='flex' alignItems='center'direction='column' lgDirection='row'>
                  <Box padding={4} width="50%">
                    <Text>When an issue is so severe that it’s hard to continue with a good experience</Text>
                  </Box>
                  <Box padding={4} width="50%">
                    <WebsiteBlocked />
                  </Box>
                ...
                <Box display='flex' alignItems='center'direction='column' lgDirection='row'>
                  <Box padding={4} width="50%">
                    <Text>To warn a person of something that can have serious consequences before they continue</Text>
                  </Box>
                  <Box padding={4} width="50%">
                    <SiteSpam />
                  </Box>
                ...
                <Box display='flex' alignItems='center'direction='column' lgDirection='row'>
                  <Box padding={4} width="50%">
                    <Text>As an interstitial that leads to a much better experience we think a person shouldn’t miss</Text>
                  </Box>
                  <Box padding={4} width="50%">
                    <ExperienceTrends />
                  </Box>
          ...
          <Box>
            ...
            <Box color='errorWeak'>
              <Flex direction='column'>
                ...
                <Box display='flex' alignItems='center'direction='column' lgDirection='row'>
                  <Box padding={4} width="50%">
                    <Text>To acknowledge completion of a task that doesn’t require follow up, like pinning to a board. Use <Link href='/web/toast' underline='always' inline>Toast</Link> instead.</Text>
                  </Box>
                  <Box padding={4} width="50%">
                    <PinSaved />
                  </Box>
                ...
                <Box display='flex' alignItems='center'direction='column' lgDirection='row'>
                  <Box padding={4} width="50%">
                    <Text>To provide general information and recommendations. Use <Link href='/web/callout' underline='always' inline>Callout</Link> instead.</Text>
                  </Box>
                  <Box padding={4} width="50%">
                    <NewRecommendations />
                  </Box>
                ...
                <Box display='flex' alignItems='center'direction='column' lgDirection='row'>
                  <Box padding={4} width="50%">
                    <Text>To show an error or warning that applies to a section of a page, or that doesn’t severely limit the user experience.</Text>
                  </Box>
                  <Box padding={4} width="50%">
                    <CampaignIssue />
                  </Box>
        ...
        <MainSection.Subsection title="Not-blocking">
          ...
          <Text>Current components: <Link href='/web/toast' underline='always'>Toast</Link></Text>
        </MainSection.Subsection>
        <MainSection.Subsection title="On surface">
          ...
          <Text>Current components: <Link href='/web/callout' underline='always'>Callout</Link> <Link href='/web/slimbanner' underline='always'>SlimBanner</Link> <Link href='/web/upsell' underline='always'>Upsell</Link></Text>

          <Heading size='300' accessibilityLevel={4}>Ephemeral—less prominent</Heading>
          <Section />
          <Text>Place messages at the top of a page, below the main app nav if the alert or information applies to the entire page. Avoid stacking messages so that a person’s view isn’t cluttered and they can’t focus on the main information they came to see and interact with. Show the highest-severity ones first.</Text>
          <Text>Current components: <Link href='/web/slimbanner' underline='always'>SlimBanner</Link></Text>
        </MainSection.Subsection>
      </MainSection>
    </Page>
  );
