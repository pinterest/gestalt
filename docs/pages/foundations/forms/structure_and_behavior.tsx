...
export default function StructureBehaviorPage() {
  return (
...
`}
        />
        <Box borderStyle="sm" maxHeight={802} maxWidth={600} rounding={4}>
          <Mask rounding={4}>
            <Image
...
Section titles describe a group of form fields and controls within the form and should fit within the form hierarchy by being one header size smaller than the heading while remaining larger than form field text sizes. We recommend Heading/md (font size 500) for section headers. Subtext can be added to sections if needed, we recommend Body/lg (font size 300) for subtext."
      ...
      <MainSection name="Form fields and controls">
        ...
        <MainSection name="Buttons">
          <MainSection.Subsection
            ...
            title="Placement"
          />
          <Box borderStyle="sm" maxHeight={586} maxWidth={570} rounding={4}>
            <Mask rounding={4}>
              <Image
          ...
          <Box borderStyle="sm" maxHeight={565} maxWidth={570} rounding={4}>
            <Mask rounding={4}>
              <Image
        ...
        <Box marginBottom={12} marginTop={0} width="100%">
          <MainSection
            description={`
          ...
          />
          <Box borderStyle="sm" maxHeight={1347} maxWidth={672} rounding={4}>
            <Mask rounding={4}>
              <Image
      ...
      <MainSection name="Behavior">
        ...
        />
        <Box marginBottom={12} marginTop={2} maxHeight={780} maxWidth={375}>
          <Image
