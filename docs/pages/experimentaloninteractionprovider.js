...
export default function ExperimentalOnInteractionProviderPage({
  generatedDocGen,
}: {|
...
|}): Node {
  return (
    <Page title="ExperimentalOnInteractionProvider">
      <PageHeader name="ExperimentalOnInteractionProvider" description={generatedDocGen?.description} />
...
`}
      ...
      <MainSection name="Related">
        <MainSection.Subsection
          description={`
      **[ExperimentalOnInteractionProvider](/ExperimentalOnInteractionProvider)**
...
export async function getStaticProps(): Promise<{| props: {| generatedDocGen: DocGen |} |}> {
  return {
    props: { generatedDocGen: await docgen({ experimentaloninteractionprovider: 'ExperimentalOnInteractionProvider' }) },
  };
}
