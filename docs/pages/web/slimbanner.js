...
import main from '../../examples/slimbanner/main';
import messagePropExample from '../../examples/slimbanner/messagePropExample';
import oneSlimBannerPerSection from '../../examples/slimbanner/oneSlimBannerPerSection';
import placeNearMostRelatedElement from '../../examples/slimbanner/placeNearMostRelatedElement';
import primaryActionExample from '../../examples/slimbanner/primaryActionExample';
import responsiveExample from '../../examples/slimbanner/responsiveExample';
import systemMessagesExample from '../../examples/slimbanner/systemMessagesExample';
import variantError from '../../examples/slimbanner/variantError';
import variantInfo from '../../examples/slimbanner/variantInfo';
import variantNeutral from '../../examples/slimbanner/variantNeutral';
import variantRecommendation from '../../examples/slimbanner/variantRecommendation';
import variantSuccess from '../../examples/slimbanner/variantSuccess';
import variantWarning from '../../examples/slimbanner/variantWarning';
...
Use a regular SlimBanner with a background for dense interfaces where space is an issue.`}
        ...
        <MainSection.Subsection columns={1}>
          ...
          <MainSection.Card
            ...
            type="don't"
            description={`
Combine SlimBanners with other components like [Callouts](/web/callout) or [Upsells](/web/bannerupsell).`}
            sandpackExample={
              <SandpackExample
