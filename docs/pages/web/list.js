...
export default function ListPage({ generatedDocGen }: {| generatedDocGen: DocGen |}): Node {
  return (
    <Page title="List">
      <PageHeader name="List" description={generatedDocGen?.description} />
...
export async function getStaticProps(): Promise<{| props: {| generatedDocGen: DocGen |} |}> {
  return {
    props: { generatedDocGen: await docgen({ componentName: 'List' }) },
  };
}
