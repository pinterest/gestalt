...
import avatarExample from '../../examples/searchguide/avatar';
import colors from '../../examples/searchguide/colors';
import expandableExample from '../../examples/searchguide/expandable';
...
import selectedStateExample from '../../examples/searchguide/selectedState';
