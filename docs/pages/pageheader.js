      ...
      <MainSection name="Best practices">
        <MainSection.Subsection>
          <MainSection.Card
            cardSize="lg"
            type="do"
            description="Use only one primary action style in the PageHeader. This should also be the only primary action on the page."
            defaultCode={`
<Box width="100%">
  <PageHeader
    title="Audiences"
...
`}
          ...
          <MainSection.Card
            cardSize="lg"
            type="don't"
            description="Use more than one primary action style on the page header, or include a primary action when there’s already a primary action elsewhere on the page"
            defaultCode={`
function Example() {
  const HeaderRow = ({ id }) => {
    return (
...
`}
          ...
          <MainSection.Card
            cardSize="lg"
            type="don't"
            description="Provide maxWidth for the PageHeader content that is different from the page content"
            defaultCode={`
<Box width="100%" color="white">
  <PageHeader
    maxWidth="65%"
...
`}
          ...
          <MainSection.Card
            cardSize="lg"
            type="don't"
            description="Include a profile avatar image in the PageHeader, as the user avatar should be provided in the main app header."
            defaultCode={`
<Box width="100%">
  <PageHeader
    title="My apps"
  ...
  />
        ...
        `}
          ...
          <MainSection.Card
            ...
            type="don't"
            description={`
Overload the PageHeader with a help IconButton, help Link and info icons. These may amount to visual noise once a user understands the page contents.`}
            defaultCode={`
<Box width="100%">
  <PageHeader
    title="Ads overview"
...
<Box width="100%">
  <PageHeader
    ...
    helperIconButton={{
          accessibilityLabel: 'Read more information about the new Shopify integration',
          onClick: () => {},
        }}
    thumbnail={
          <Image
...
Primary and secondary actions are replaced with a [Dropdown](https://gestalt.netlify.app/dropdown) below the [sm breakpoint](https://gestalt.netlify.app/screen_sizes#Web-(px)). \`secondaryAction\` takes both the main component and its equivalent using Dropdown subcomponents.
...
`}
        ...
        <MainSection.Subsection
          description={`PageHeader supports a bottom border to show the division between PageHeader and page content below.`}
          title="Border"
        >
          <MainSection.Card
            shaded
...
<Box width="100%" height={100} color="white">
  <PageHeader
    ...
    subtext="2,131 catalog products."
    helperLink={{
      text: "Learn more about bulk prodcut catalog uploads.",
      href: "http://www.pinterest.com",
      onClick: () => {} }}
    primaryAction={{
      component: <Button color="red" size="lg" text="Quick create" />,
...
- Make page titles, subtext and action text lengthy so that it truncates quickly at smaller screen sizes.`}
      ...
      <MainSection name="Related">
        <MainSection.Subsection
          description={`
      **[Heading](/heading)**
       Heading allows you to show headings on the page, therefoe, it should be used to create level 2-6 headings on a page. If a level 1 heading is needed, use PageHeader. Use as a title for sections below the PageHeader, or for when a page needs a title but doesn’t warrant a PageHeader.
    `}
        />
      </MainSection>
    </Page>
