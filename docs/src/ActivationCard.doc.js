    ...
    props={[
      ...
      },
      {
        ...
        description: [
          ...
          `- onNavigationOptions: Pass custom props to onNavigation. See Provider for examples. onNavigation's type is flexible. Each key's value is a React.Node or an event handler function.`,
