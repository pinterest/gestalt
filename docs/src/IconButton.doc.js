...
card(
  <PageHeader
    name="IconButton"
    description="IconButton allow users to take actions and make choices with a single click on a specific Icon. They are typically found in forms, dialog, and toolbars. Some buttons are specialized for particular tasks, such as navigation or presenting menus."
  />
);
    ...
    props={[
      ...
      },
      {
        ...
        description: [
          ...
          'Optional with button-role IconButton.',
      ...
      },
      {
        ...
        required: false,
        defaultValue: 'gray',
        description: ['Primary colors to apply to the Gestalt Icon.'],
        href: 'iconColor',
      },
      {
        name: 'icon',
        ...
        description: [
          ...
          'Accessibility: Icons are visual informacion and are not accessible for screen readers.  `accessibilityLabel` must be passed to provide sufficient context to the IconButton.',
        ],
        href: '',
      },
      {
      ...
      },
      {
        ...
        description: [
          ...
          'Required with button-role IconButtons.',
        ],
        href: 'selected',
      },
      {
      ...
      },
      {
        ...
        defaultValue: 'md',
        description:
          'Display an IconButton in different sizes. Size changes the component padding modifying its fixed height: xs (24px), sm (32px), md (40px), lg (48px), xl (56px).',
        href: 'size',
      },
      {
        name: 'target',
