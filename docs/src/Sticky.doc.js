    ...
    props={[
      {
        name: 'bottom',
        type: 'number | string',
        description: `Use numbers for pixels: bottom={100} and strings for bottom: width="100%"`,
      },
      {
        name: 'children',
        type: 'React.Node',
      },
      {
        name: 'left',
        type: 'number | string',
        description: `Use numbers for pixels: left={100} and strings for bottom: left="100%"`,
      },
      {
        name: 'right',
        type: 'number | string',
        description: `Use numbers for pixels: right={100} and strings for bottom: right="100%"`,
      },
      {
        name: 'top',
        type: 'number | string',
        description: `Use numbers for pixels: top={100} and strings for bottom: top="100%"`,
      },
      {
