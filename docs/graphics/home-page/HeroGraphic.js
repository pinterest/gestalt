...
export default function Hero({ animate = true }: {| animate?: boolean |}): Node {
  return (
    <svg
      width="501"
      height="392"
    ...
    >
      ...
      <path
        ...
        fill="#D7EDFF"
      />
      <circle className={animate && 'animation-3'} cx="301" cy="37" r="19" fill="#007CFF" />
      <rect
        className={animate && 'animation-3'}
        x="294.667"
        y="30.6667"
        width="12.6667"
        height="12.6667"
      ...
      />
      <circle
        className={animate && 'animation-2'}
        r="30"
        transform="matrix(-1 0 0 1 95.0001 55)"
        fill="#007CFF"
      />
      <g clipPath="url(#clip0_263_5069)" className={animate && 'animation-2'}>
        <path
